...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Runs the specified python file with optionally provided arguments.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="Directory path to file to execute, relative to the working directory (default is the working directory itself)",
            ),
            "args": types.Schema(
                ...
                description="A list of optional arguments that can be extended to the command if the function requries it.",
            )
        },
    ),
)